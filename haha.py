...
def waktu(secs):
    ...
    return '%02d Month %02d Days %02d Hours %02d Minutes %02d Seconds' % (year, month, days, hours, mins, secs)
                    ...
                    if Squad["autoRead"] == True:
                        ...
                        if rfuText.lower() == 'PROSES TRANSISI':
                            ...
                            if user in RfuSekawan or user in Squad["Admin"]:
                                ...
                                #owner = "uac8e3eaf1eb2a55770bf10c3b2357c33"
                                cl.mentionWithRFU(sender,owner,"さようなら\n" + str(" ("+ginfo.name+")"))
                                ...
                                ginfo = cl.getGroup(kirim)
                                #owner = "uac8e3eaf1eb2a55770bf10c3b2357c33"
                                riden1.mentionWithRFU(sender,owner,"さようなら\n" + str(" ("+ginfo.name+")"))
