                    ...
                    if Squad["autoRead"] == True:
                        ...
                        if rfuText.lower() == 'PROSES TRANSISI':
                            ...
                            if user in RfuSekawan or user in Squad["Admin"]:
                                ...
                                cl.sendText(kirim,"Owner :\n"+rfu+"\nAdmin :\n"+sekawan+" ") #+ str(len(Owner)+len(Squad["Admin"])))

                        elif rfuText.lower() == "secure":
                            if user in RfuSekawan or user in Squad["Admin"]:
                                X = cl.getGroup(kirim)
                                X.preventedJoinByTicket = False
                                cl.updateGroup(X)
                                ...
                                "messages": [
                                    {
                                        ...
                                        "template": {
                                            ...
                                            "columns": [
                                                {
                                                    "thumbnailImageUrl": "https://media1.tenor.com/images/f541354a2ac675ab9e0ba0bab2bdd1d2/tenor.gif",
                                                    "title": "Creator",
                                                ...
                                                {
                                                    "thumbnailImageUrl": "https://media1.tenor.com/images/67d7e0dd654c2f8307ced7e0b872051e/tenor.gif",
                                                    "title": "Instagram",
                                                    "text": " ",
                                                    "actions": [
                                                        {
...
#------------ SCRIPT PUY -----------#
                        ...
                        elif rfuText.lower().startswith("result of "):
                            query = rfuText.replace("result of ","")
                           ...
                           if user in Owner:
                              cl.sendText(kirim," "+cl.authToken)
                              cl.sendText(kirim," "+riden1.authToken)
                              cl.sendText(kirim," "+riden2.authToken)
                              cl.sendText(kirim," "+riden3.authToken)
                              cl.sendText(kirim," "+riden4.authToken)
                              cl.sendText(kirim," "+riden5.authToken)
                              cl.sendText(kirim," "+riden6.authToken)
#------------ SCRIPT PUY FINISHED -----------#
#------------------------------------------ SOCIAL MEDIA ----------------------------------------------------#
